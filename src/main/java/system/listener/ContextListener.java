...
public class ContextListener implements ServletContextListener {
    ...
    public void contextDestroyed(ServletContextEvent arg0)  { 
    	...
    	ScheduledFuture sf= (ScheduledFuture)arg0.getServletContext().getAttribute("scheduledFuture");
    	sf.cancel(true);
    }
...
//    	event.getServletContext().setAttribute("scheduledFuture",schedule.addTask(reSetMillis-nowMillis, 1000*60*60*24));
