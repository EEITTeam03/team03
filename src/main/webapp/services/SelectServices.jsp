	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<ul class="nav navbar-right top-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown"><i class="fa fa-user"></i> 管理員 <b
						class="caret"></b></a>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					<li><a href="#"><i class="fa fa-car"></i> 管理工作排程</a></li>
					<!--                     <li> -->
					<!--                         <a href="#"><i class="fa fa-fw fa-table"></i> 維護服務項目</a> -->
					<!--                     </li> -->
					<li class="active"><a href="../services/SelectServices.jsp"><i
							class="fa fa-fw fa-table"></i> 維護服務項目</a></li>
					...
					<li><a href="#" data-toggle="collapse" data-target="#demo"><i
							class="fa fa-fw fa-arrows-v"></i> 維護名單<i
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<ul>
						<li><a href='ListAllServices.jsp'>查看</a>所有服務 (後台)</li>
						<br>
						<li><a href='ServicesInsert.jsp'>新增</a>服務 (後台)</li>
						<br>
						<li><a href='ListAllServiceStep.jsp'>查看</a>所有服務步驟 (後台)</li>
						<br>
						<li><a href='ListAllServiceStepForUser.jsp'>查看</a>所有服務 (前台)</li>
						<br>
						<li><a href='ListAllServicesForUser.jsp'>查看</a>所有服務 (前台)</li>
						<br>
