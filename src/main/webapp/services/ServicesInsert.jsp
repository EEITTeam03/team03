	...
	function format_float(num, pos)
{
	...
	function ch(){
		...
		document.getElementById('ForservPriceM').value = 1200;
		document.getElementById('ForservTimeM').value = 30;
		document.getElementById('ForservPriceL').value = 1500;
		document.getElementById('ForservTimeL').value = 40;
		document.getElementById('ForservPriceXL').value = 2000;
		document.getElementById('ForservTimeXL').value = 40;
		document.getElementById('ForservPriceXXL').value = 2200;
		document.getElementById('ForservTimeXXL').value = 50;
